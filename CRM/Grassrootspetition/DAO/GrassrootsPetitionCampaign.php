 ...
 * (GenCodeChecksum:416c8334a6d988e895ee2f68cab926c6)
 */
...
class CRM_Grassrootspetition_DAO_GrassrootsPetitionCampaign extends CRM_Core_DAO {
  ...
  /**
   * HTML template for new petitions
   *
   * @var longtext
   */
  public $template;
  ...
  public static function getEntityTitle() {
    return E::ts('Grassroots Petition Campaigns');
  }
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'template' => [
          ...
          'type' => CRM_Utils_Type::T_LONGTEXT,
          'title' => E::ts('Template'),
          'description' => E::ts('HTML template for new petitions'),
          'where' => 'civicrm_grpet_campaign.template',
          'table_name' => 'civicrm_grpet_campaign',
          'entity' => 'GrassrootsPetitionCampaign',
          'bao' => 'CRM_Grassrootspetition_DAO_GrassrootsPetitionCampaign',
          'localizable' => 0,
