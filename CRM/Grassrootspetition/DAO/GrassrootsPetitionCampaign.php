 ...
 * (GenCodeChecksum:c638632c798be34a60510eb1b68968cb)
 */
...
class CRM_Grassrootspetition_DAO_GrassrootsPetitionCampaign extends CRM_Core_DAO {
  ...
  /**
   * Alternative text for default campaign image
   *
   * @var string
   */
  public $template_image_alt;

  /**
   * Default tweet for new petitions
   *
   * @var string
   */
  public $template_tweet;
  ...
  /**
   * FK to MessageTemplate for opted-in signers of this campaign
   *
   * @var int
   */
  public $thanks_msg_template_id;

  /**
   * FK to MessageTemplate for not-opted-in signers of this campaign
   *
   * @var int
   */
  public $confirm_msg_template_id;

  /**
   * What data can be downloaded by petition owners by default JSON array or empty to mean global defaults.
   *
   * @var string
   */
  public $download_permissions;

  /**
   * Whether to allow mailings by default. Valid values are default/yes/no
   *
   * @var string
   */
  public $allow_mailings;
  ...
  public static function getReferenceColumns() {
    if (!isset(Civi::$statics[__CLASS__]['links'])) {
      ...
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'thanks_msg_template_id', 'civicrm_msg_template', 'id');
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'confirm_msg_template_id', 'civicrm_msg_template', 'id');
  ...
  public static function &fields() {
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'template_image_alt' => [
          'name' => 'template_image_alt',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => E::ts('Template Image Alt'),
          'description' => E::ts('Alternative text for default campaign image'),
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
          'where' => 'civicrm_grpet_campaign.template_image_alt',
          'table_name' => 'civicrm_grpet_campaign',
          'entity' => 'GrassrootsPetitionCampaign',
          'bao' => 'CRM_Grassrootspetition_DAO_GrassrootsPetitionCampaign',
          'localizable' => 0,
        ...
        'template_tweet' => [
          'name' => 'template_tweet',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => E::ts('Template Tweet'),
          'description' => E::ts('Default tweet for new petitions'),
          'maxlength' => 512,
          'size' => CRM_Utils_Type::HUGE,
          'where' => 'civicrm_grpet_campaign.template_tweet',
          'table_name' => 'civicrm_grpet_campaign',
          'entity' => 'GrassrootsPetitionCampaign',
          'bao' => 'CRM_Grassrootspetition_DAO_GrassrootsPetitionCampaign',
          'localizable' => 0,
        ...
        'thanks_msg_template_id' => [
          'name' => 'thanks_msg_template_id',
          'type' => CRM_Utils_Type::T_INT,
          'description' => E::ts('FK to MessageTemplate for opted-in signers of this campaign'),
          'where' => 'civicrm_grpet_campaign.thanks_msg_template_id',
          'table_name' => 'civicrm_grpet_campaign',
          'entity' => 'GrassrootsPetitionCampaign',
          'bao' => 'CRM_Grassrootspetition_DAO_GrassrootsPetitionCampaign',
          'localizable' => 0,
        ...
        'confirm_msg_template_id' => [
          'name' => 'confirm_msg_template_id',
          'type' => CRM_Utils_Type::T_INT,
          'description' => E::ts('FK to MessageTemplate for not-opted-in signers of this campaign'),
          'where' => 'civicrm_grpet_campaign.confirm_msg_template_id',
          'table_name' => 'civicrm_grpet_campaign',
          'entity' => 'GrassrootsPetitionCampaign',
          'bao' => 'CRM_Grassrootspetition_DAO_GrassrootsPetitionCampaign',
          'localizable' => 0,
        ...
        'download_permissions' => [
          ...
          'type' => CRM_Utils_Type::T_STRING,
          'title' => E::ts('Download Permissions'),
          'description' => E::ts('What data can be downloaded by petition owners by default JSON array or empty to mean global defaults.'),
          'maxlength' => 128,
          'size' => CRM_Utils_Type::HUGE,
          'where' => 'civicrm_grpet_campaign.download_permissions',
          'table_name' => 'civicrm_grpet_campaign',
          'entity' => 'GrassrootsPetitionCampaign',
          'bao' => 'CRM_Grassrootspetition_DAO_GrassrootsPetitionCampaign',
          'localizable' => 0,
          'pseudoconstant' => [
            'optionGroupName' => 'grpet_download_permissions',
            'optionEditPath' => 'civicrm/admin/options/grpet_download_permissions',
          ],
          'add' => NULL,
        ],
        'allow_mailings' => [
          'name' => 'allow_mailings',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => E::ts('Allow Mailings'),
          'description' => E::ts('Whether to allow mailings by default. Valid values are default/yes/no'),
          'maxlength' => 8,
          'size' => CRM_Utils_Type::EIGHT,
          'where' => 'civicrm_grpet_campaign.allow_mailings',
          'default' => 'default',
          'table_name' => 'civicrm_grpet_campaign',
          'entity' => 'GrassrootsPetitionCampaign',
          'bao' => 'CRM_Grassrootspetition_DAO_GrassrootsPetitionCampaign',
