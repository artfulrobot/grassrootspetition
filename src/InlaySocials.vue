<!-- InlaySocials v1.2.1
  ...
  - socials: ordered array of social items. Each has a name, and may require extra metadata. e.g.
    [
      { name: 'facebook' },
      { name: 'twitter', tweet: 'Something hillarious' },
      ...
    ]
  - icons: boolean. If true, show icons on the buttons.
  - buttonStyle: string class name. Implemented styles: 'col-buttons' or 'col-icon'
